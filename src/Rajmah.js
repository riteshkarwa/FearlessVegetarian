    ...
    render() {
        return (
            <div>
                ...
                <div className="ingredients"><h3>Ingredients</h3>
                    <ul className="ingredient-list">
                        <li><FontAwesomeIcon icon={faCarrot} className="ingredient-icon" />
                            1 cup dried Rajma (Red Kidney Beans)</li>
                        <li><FontAwesomeIcon icon={faCarrot} className="ingredient-icon" />Water for soaking and cooking</li>
                        <li><FontAwesomeIcon icon={faCarrot} className="ingredient-icon" />2 tablespoons oil or ghee</li>
                        ...
                        <li><FontAwesomeIcon icon={faCarrot} className="ingredient-icon" />2 teaspoons ginger-garlic paste</li>
                        <li><FontAwesomeIcon icon={faCarrot} className="ingredient-icon" />1-2 green chilies, finely chopped (adjust to taste)</li>
                        ...
                        <li><FontAwesomeIcon icon={faCarrot} className="ingredient-icon" />1 teaspoon red chili powder (adjust to taste)</li>
                ...
                <Image
                    src="/rajmah.jpg"
                    alt="Authentic Punjabi Rajma Masala made with kidney beans in a rich tomato onion gravy"
                    fluid
                    rounded
                    thumbnail
                    loading="lazy"
