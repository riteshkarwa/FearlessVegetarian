    ...
    return (
      <div>
        ...
        <ol> 
            ...
            <li>Add a peice of bread with layer of butter applied to the bottom of the bread</li> 
            ...
            <li>Add a peice of bread with layer of butter applied to the bottom of the bread. to complete our sandwich</li>  
        </ol>
      </div>
    );
  }
